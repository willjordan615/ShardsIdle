...
| `skill_fireball` | Fireball | DAMAGE_MAGIC | Damage (Magic/AOE) | — |
| `skill_lightning` | Lightning Strike | DAMAGE_MAGIC | Damage (Magic/AOE) | — |
...
| `misdirect` | Misdirect | DEFENSE | Defense | — |
| `first_aid` | First Aid | HEALING | Healing | — |
| `heal_major` | Major Heal | HEALING | Healing | — |
| `skill_resurrect` | Resurrect | HEALING | Healing | — |
| `skill_resurrect_party` | Mass Resurrect | HEALING | Healing | — |
| `attunement` | Attunement | UTILITY | Support/Buff | — |
| `bloodlust` | Bloodlust | BUFF | Support/Buff | — |
| `buff_all_stats` | All Stats Buff | BUFF | Support/Buff | — |
| `buff_defense` | Defense Buff | BUFF | Support/Buff | — |
| `buff_loot_rate` | Loot Rate Buff | BUFF | Support/Buff | — |
| `buff_speed` | Speed Buff | BUFF | Support/Buff | — |
| `buff_strength` | Strength Buff | BUFF | Support/Buff | — |
...
| `restore_mana_major` | Major Mana Restoration | RESTORATION | Support/Buff | — |
| `restore_mana_minor` | Minor Mana Restoration | RESTORATION | Support/Buff | — |
| `restore_stam_minor` | Minor Stamina Restoration | RESTORATION | Support/Buff | — |
| `restore_stam_small` | Small Stamina Restoration | RESTORATION | Support/Buff | — |
| `reveal_area` | Reveal Area | UTILITY | Support/Buff | — |
| `sense` | Sense | UTILITY | Support/Buff | — |
| `shout` | Shout | BUFF | Support/Buff | — |
| `skill_teleport` | Teleport | UTILITY | Support/Buff | — |
...
| `deploy_caltrops` | Deploy Caltrops | TRAP | TRAP | — |
| `deploy_trap_stun` | Deploy Stun Trap | TRAP | TRAP | — |
