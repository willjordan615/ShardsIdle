...
const MERCHANTS = [
  {
    ...
    itemPool: [
      ...
      'stamina_potion_minor', 'stamina_potion', 'stamina_potion_major',
      'antidote', 'elixir_vitality',
      'consumable_food_ration', 'food_hearty_meal', 'consumable_food_feast',
  ...
  },
  {
    ...
    itemPool: [
      ...
      'smoke_bomb', 'consumable_poison_blade',
    ],
    priceMultiplier: 0.9,
  },
];
